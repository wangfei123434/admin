<template>
  <V-Table url="/rentserver/backend/studentHouse/selectHouseList" :parse="true">
    <template #query="{ query }">
      <el-form-item label="登记意向区域" class="area">
        <el-select v-model="query.xyRegion" placeholder="请选择">
          <el-option
      ...
      <el-form-item label="签约状态">
        <el-select v-model="query.selectStatus" placeholder="请选择">
          <el-option
      ...
      <el-form-item label="人才类型">
        <el-select v-model="query.talentType" placeholder="请选择">
          <el-option
    ...
    <el-table-column
      ...
      align="center"
    ></el-table-column>
    <el-table-column label="房源信息" prop="houseInfo"></el-table-column>
    <!-- <el-table-column label="操作">
      <template #default>
        <a style="margin-right: 10px">在线签约</a>
      </template>
    </el-table-column> -->
  </V-Table>
</template>
